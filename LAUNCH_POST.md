...
This file contains short public descriptions that can be reused across channels.
...
I just open-sourced Klava, a desktop agent project for local tasks, guarded shell work, approvals, and task history.
